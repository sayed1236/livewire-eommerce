...
class CountriesCities extends Component
{
    ...
    public function mount($parent_id=0)
    {
        ...
        if($this->parent_id ==0)
        {
            $this->title_page=__('ms_lang.Governorates'); 
        }else
        {
    ...
    {
        $results= CountriesCity::whereParentId($this->parent_id)->get()->sortByDesc('ord');
        return view('admin::livewire.admin.countries-cities.countries-cities',
                    [
                        'results'=>$results,
