...
class Coupons extends Component
{
    ...
    {
        $results=Coupon::all();
        return view('admin::livewire.admin.coupons.coupons',[
            'results'=>$results
    ...
    public function edit_form($id=0)
    {
        ...
        if($id > 0)
        {
            ...
            $edit_object= Coupon::where('deleted_at',null)->whereId($id)->first();
        }
        else
        {
            if($this->showForm == true)
    ...
    {
        $data= Coupon::select('id','is_active')->find($id);
        if($data->is_active == 'Y')
        {
            $data->is_active='N';
        }
    ...
    {
        $data= Coupon::select('id','deleted_at')->find($id);
