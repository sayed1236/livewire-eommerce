...
?>
                <tr>
                    ...
                    <td style="padding: 0px;width: 25%;">
                        ...
                        <button wire:click='detatils({{ $result->id }})' class="btn btn-success">التفاصيل</button>
                        <a href="javascript:void(0);" wire:click='active_ms({{ @$result->id }})' class="btn btn-default bg-info text-white">الموافقه علي المنتج</a>
                        <a href="javascript:void(0);" wire:click='refused({{ @$result->id }})' class="btn btn-default bg-danger text-white">رفض</a>
...
<?php endif; ?>
        ...
        @include('livewire.admin.user-products.details')
</div>
