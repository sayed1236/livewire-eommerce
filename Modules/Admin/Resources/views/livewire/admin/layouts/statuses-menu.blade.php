<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item ms-1 ms-md-3">
        <a href="{{ url('./') }}" target="_blank" class="text-center bg-default">{{ __('ms_lang.go2site') }}
            <br/>
        ...
        <div class="app-navbar-item ms-1 ms-md-3">
            <!--begin::Menu- wrapper-->
            <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="{{ @$data_kt_menu_placement_bottom }}">
        ...
        <div class="app-navbar-item ms-1 ms-md-3">
            <!--begin::Menu toggle-->
            <a href="#" class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="{{ @$data_kt_menu_placement_bottom }}">
        ...
        <!--end::Theme mode-->
        <!--begin::User menu-->
<livewire:admin::admin.layouts.user-menu />
        <!--end::User menu-->
