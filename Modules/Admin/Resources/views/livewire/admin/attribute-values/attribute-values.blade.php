...
@if ($showForm == true)
        <livewire:admin::admin.attribute-values.edit />
@elseif ($showDeleted == true)
        <livewire:admin::admin.attribute-values.deleted />
@else
          ...
          <table class="table table-bordered table-hover table-checkable" id="kt_datatable" style="margin-top: 13px !important">
            <thead>
              <tr>
                ...
                <th>{{ trans('ms_lang.attributes') }}</th>
                <th>{{ __('ms_lang.value') }}</th>
...
?>
                <tr>
                    ...
                    <td>{{ Auth::user()->user_lang=='ar' ? @$result->attribute->name : @$result->attribute->name_en }}</td>
                    <td>{{ $result->value }}</td>
