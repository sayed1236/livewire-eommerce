...
<livewire:admin::admin.categories.edit />

{{-- @if ($showDeleted == true )
        <livewire:admin::admin.categories.deleted />
@endif --}}
                ...
                <tr>
                    ...
                    <td style="padding: 0px;width: 30%;">
                        <!---------- active & Dis active Button --->
                         ...
                         <a href="{{ url(config('app.url_admin').'category/'.$type.'/'.$result->id.'') }}" class="btn btn-sm px-1 btn-default bg-info text-white">
                            {{ __('ms_lang.sub_categories') }}
                        </a>
