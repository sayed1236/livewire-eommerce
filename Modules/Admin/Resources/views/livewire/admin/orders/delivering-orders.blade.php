...
?>
                <tr>
                    ...
                    <td style="padding: 0px;width: 20%;">
                        ...
                        <a href="javascript:void(0);" wire:click='confirm_order({{ @$result->id }})' class="btn btn-default bg-info">تم توصيل الطلب</a>
...
{{--  @include('admin::livewire.admin.orders.order-details-modal')  --}}
</div>
