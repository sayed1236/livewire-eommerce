...
?>
                <tr>
                    ...
                    <td style="padding: 0px;width: 20%;">
                       ...
                       @if ($result->is_done !='canceled')
                        <a href="javascript:void(0);" wire:click='confirm_canceled_order({{ @$result->id }})' class="btn btn-default bg-info">تأكيد الالغاء</a>
                       @endif
...
{{--  @include('livewire.admin.orders.order-details-modal')  --}}
</div>
