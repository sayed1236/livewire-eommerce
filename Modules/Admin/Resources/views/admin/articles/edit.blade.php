...
@endif
            ...
            <div class="box-body pad">
                ...
                <form @if (isset($result->id))
                        action="{{route('articles.update', $result->id ) }}"
                    @else
...
@endif
                    ...
                    <div class="form-group col-md-6 <?php echo @$dis_det; ?>">
                        <label for="brief">نبذه </label>
                        <textarea name="brief"  class="form-control " rows="1"  placeholder="اضف ...">{{ @$result->brief }}</textarea>
                    </div>
                    <div class="form-group col-md-6 <?php echo @$dis_det; ?>">
                        <label for="brief_en">Brief En </label>
                        <textarea name="brief_en" class="form-control " rows="1"  placeholder="Enter ...">{{ @$result->brief_en }}</textarea>
                    </div>
