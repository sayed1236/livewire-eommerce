...
<div class="card card-custom">
	<div class="card-header flex-wrap py-5">
		...
		<div class="card-toolbar">
			...
			<a href="{{ url(config('app.url_admin').'old-trending') }}"  class="btn btn-primary font-weight-bolder">
			  <span class="svg-icon svg-icon-md"> <i class="icon-xl fas fa-list text-danger"></i>{!! trans('ms_lang.btn_view_old') !!}
            </a>
