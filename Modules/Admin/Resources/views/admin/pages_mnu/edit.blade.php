          ...
          <div class="box box-info">
            ...
            <div class="box-body pad">
                <form @if (isset($result->id))
                        action="{{route('pages_mnu.update', $result->id ) }}"
                    @else
                        action="{{route('pages_mnu.store') }}"
                    @endif
                 ...
                 method="post" enctype="multipart/form-data" >
                   ...
                   <div class="form-group col-md-6">
                        <label for="name_en">page_url</label>
                        <input type="text" name="page_url" value="{{ @$result->page_url }}" class="form-control" id="name_en" placeholder=""  />
                    </div>
                    <div class="form-group col-md-6">
                        <label for="img">img</label>
                        <input type="text" name="img" value="{{ @$result->img }}" class="form-control" id="img" placeholder=""  />
                    </div>
