...
{{--  <link rel="stylesheet" type="text/css" href="assets/vendor/animate/animate.min.css">  --}}
    ...
    <!-- Plugins CSS -->
    <link rel="stylesheet" type="text/css" href="{{ url('site/vendor/nouislider/nouislider.min.css') }}">
    ...
    <div class="page-content">
        <div class="container">
            ...
            <div class="shop-default-banner banner d-flex align-items-center mb-5 br-xs"
                style="background-image: url({{ url('site/images/shop/banner1.jpg') }}); background-color: #FFC74E;">
                ...
                <div class="brands-swiper swiper-container swiper-theme "
                    ...
                    <div class="swiper-wrapper row gutter-no cols-xl-7 cols-lg-6 cols-md-4 cols-sm-3 cols-2">
                        <div class="swiper-slide">
                            <figure>
                                <img src="{{ url('site/images/brands/category/1.png') }}" alt="Brand" width="160" height="90" />
                            </figure>
                        </div>
                        <div class="swiper-slide">
                            <figure>
