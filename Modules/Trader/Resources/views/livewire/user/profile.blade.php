            ...
            <div class="tab tab-vertical">
                ...
                <div class="profile-top text-center">
                            <div class="profile-image mb-1">
                                <img class="rounded-circle blur-up" src="{{ url('site/images/user-img3.jpg') }}" alt="user" width="130">
                            </div>
                            <div class="profile-detail">
                                <h3 class="mb-0">Jecno Janesen</h3>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane mb-4" id="account-orders">
                        ...
                        <table class="shop-table account-orders-table mb-6">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="order-status status-success">completed</td>
                                    ...
                                    <td class="order-action">
                                        <a href="order.html"
                                            class="btn btn-outline btn-default btn-block btn-sm btn-rounded">View</a>
                                                                                            ...
                                                                                            <a href="track.html"
                                            class="btn btn-outline btn-default btn-block btn-sm btn-rounded">track order</a>
                                ...
                                <tr>
                                    ...
                                    <td class="order-date">August 20, 2021</td>
                                    <td class="order-status status-process">Processing</td>
                                    <td class="order-total">
                                        <span class="order-price">$321.00</span> for
                                        <span class="order-quantity"> 3</span> items
                                    </td>
                                    <td class="order-action">
                                        <a href="order.html"
                                            class="btn btn-outline btn-default btn-block btn-sm btn-rounded">View</a>
                        ...
                        <a href="shop-both-sidebar.html" class="btn btn-dark btn-rounded btn-icon-right">Go
