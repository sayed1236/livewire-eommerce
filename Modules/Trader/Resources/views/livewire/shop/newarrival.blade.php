            ...
            <div class="shop-content row gutter-lg">
                        ...
                        <div class="sticky-sidebar">
                            ...
                            <div class="widget widget-collapsible">
                                ...
                                @else 
                                     ...
                                     <li><a wire:click="show_category({{ $subcategory->id }})" style="cursor:pointer">{{
                            ...
                            @if(isset($attributescats->attributes))
                            
                            

                            @foreach($attributescats->attributes as $attribute)
                            ...
                            <div class="widget widget-collapsible" >
                                ...
                                <ul class="widget-body filter-items item-check">
                                    ...
                                    <div class="form-checkbox">
                                            ...
                                            <input type="checkbox"  class="custom-checkbox" id="{{$attribute_values->value }}" name="{{$attribute_values->value }}"  wire:click="getattribute({{ $attribute_values->id }})" >
                                        <label for="{{$attribute_values->value }}">{{$attribute_values->value }}</label>
                                    </div>
                ...
                <div class="main-content">
                    ...
                    <div class="product-wrapper row cols-xl-5 cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                        ...
                        <div class="product-wrap" wire:poll>
                        ...
                        <div class="product product-list">
                            ...
                            <div class="product-details">
                                ...
                                <div class="product-action">
                                    <a wire:click="add_cart({{ $product->id }})" style="cursor: pointer" class="btn-product btn-cart" title="Add to Cart"><i
