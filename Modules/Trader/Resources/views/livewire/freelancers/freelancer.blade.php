        ...
        <div class="container">
            ...
            <div class="row gutter-lg">
                ...
                <div class="main-content">
                    ...
                    <div class="row cols-sm-2" styl="margin-bottom:20px">
                        <div class="store-wrap mb-4">
                            <div class="store store-grid store-wcfm">
                                <div class="store-header">
                                    <figure class="store-banner">
                                        <img src="{{ url('site/images/vendor/dokan/1.jpg') }}" alt="Vendor" width="400" height="194" style="background-color: #40475E">
                                    </figure>
                                </div>
                                <!-- End of Store Header -->
                                ...
                                <div class="store-footer">
                                    <figure class="seller-brand">
                                        <img src="{{ url('site/images/vendor/brand/1.jpg') }}" alt="Brand" width="80" height="80">
                                    </figure>
                        ...
                        <div class="store-wrap mb-4">
                            <div class="store store-grid store-wcfm">
                                <div class="store-header">
                                    <figure class="store-banner">
                                        <img src="{{ url('site/images/vendor/dokan/2.jpg') }}" alt="Vendor" width="400" height="194" style="background-color: #40475E">
                                    </figure>
                                </div>
                                <!-- End of Store Header -->
                                <div class="store-content">
                                ...
                                <div class="store-footer">
                                    <figure class="seller-brand">
                                        <img src="{{ url('site/images/vendor/brand/2.jpg') }}" alt="Brand" width="80" height="80">
                                    </figure>
                        ...
                        <div class="store-wrap mb-4">
                            <div class="store store-grid store-wcfm">
                                <div class="store-header">
                                    <figure class="store-banner">
                                        <img src="{{ url('site/images/vendor/dokan/3.jpg') }}" alt="Vendor" width="400" height="194" style="background-color: #40475E">
                                    </figure>
                                </div>
                                <!-- End of Store Header -->
                                <div class="store-content">
                                ...
                                <div class="store-footer">
                                    <figure class="seller-brand">
                                        <img src="{{ url('site/images/vendor/brand/3.jpg') }}" alt="Brand" width="80" height="80">
                                    </figure>
                        ...
                        <div class="store-wrap mb-4">
                            <div class="store store-grid store-wcfm">
                                <div class="store-header">
                                    <figure class="store-banner">
                                        <img src="{{ url('site/images/vendor/dokan/4.jpg') }}" alt="Vendor" width="400" height="194" style="background-color: #40475E">
                                    </figure>
                                </div>
                                <!-- End of Store Header -->
                                <div class="store-content">
                                ...
                                <div class="store-footer">
                                    <figure class="seller-brand">
                                        <img src="{{ url('site/images/vendor/brand/4.jpg') }}" alt="Brand" width="80" height="80">
                                    </figure>
